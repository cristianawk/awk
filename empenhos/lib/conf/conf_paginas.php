 ...
 */
    ...
    * Paginas de login
    */
    define ('PAGINA_SESS_EXPIROU',  PAGINA_ROOT.'./erro/erro.php?e=2');
    define ('PAGINA_CONS',          PAGINA_ROOT.'./erro/erro.php?e=1');
    //define ('PAGINA_CONS',          PAGINA_ROOT.'index.php?erro=1');
