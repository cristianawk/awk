...
/*
    ...
    /**
     * Instancia a chave do google maps
     */
    //$global_key_mapa = new KEYMAPA();
    // Definindo uma constante
    //define ('KEY_MAPA', $global_key_mapa->getKeyMap());
   ...
   /**
    * Instancia a classe da conexão
    */

    $global_conn = new BD (BD_HOST, BD_USER, BD_PASS, BD_NOME);
