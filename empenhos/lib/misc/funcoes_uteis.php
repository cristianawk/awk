...
function http_redir ($destino) {
    // N�o faz nada se o cabecalho HTTP j� foi enviado.
    if (headers_sent())
        return false;
    ...
    // P�ra o script para nao mostrar mais nada.
    die ();
}
...
<body>
<h2><<< A Execu��o foi interrompida!!! >>></h2>
...
<p><a href=\"".PAGINA_ROOT."\">Voltar � P�gina Inicial do SIGAT</a></p>
</body>
</html>
");
}
