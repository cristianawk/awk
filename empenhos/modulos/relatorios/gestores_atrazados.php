...
?>
<fieldset>
<legend>Consulta Gestores Atrasados</legend>
<form target="_self" enctype="multipart/form-data" method="post" name="frm_atrazados" id="frm_atrazados" >
...
<tr>
    <th colspan="4">
        <input type="button" name="btn_incluir" id="btn_incluir" value="PESQUISAR" class="botao" onclick="loadAtrazados()">
    </th>
</tr>
</table>
</form>
...
<br>
<fieldset>
<legend>GESTORES ATRASADOS: </legend>
<div id="rec"></div>
</fieldset>
<script type="text/javascript">
	...
	function loadAtrazados(){
		new Ajax.Request('./modulos/relatorios/rel_atrazados.php', {
			method: 'get',
