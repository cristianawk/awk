<?php
/*
 * Classe que controla a formatação dos campos
 */
...
class formata{
	...
	/*
	 *  Converte para maiuscula todos os caraceteres incluindo os com acentuação
	 */
	public static function fullUpper($string) {
		return strtr(strtoupper($string), array("à" => "À", "è" => "È", "ì" => "Ì", "ò" => "Ò", "ù" => "Ù", "á" => "Á", "é" => "É", "í" => "Í", "ó" => "Ó", "ú" => "Ú", "â" => "Â", "ê" => "Ê", "î" => "Î", "ô" => "Ô", "û" => "Û", "ç" => "Ç", "ã" => "Ã", "õ" => "Õ"));
    }

	/*
	 *  Converte para minuscula todos os caraceteres incluindo os com acentuação
	 */
	public static function fullLower($string) {
		return strtr(strtolower($string), array("À" => "à", "È" => "è", "Ì" => "ì", "Ò" => "ò", "Ù" => "ù", "Á" => "á", "É" => "é", "Í" => "í", "Ó" => "ó", "Ú" => "ú", "Â" => "â", "Ê" => "ê", "Î" => "î", "Ô" => "ô", "Û" => "û", "Ç" => "ç", "Ã" => "ã", "Õ" => "õ"));
    }
	...
	private static function formataCampo($atributo, $tipo="t", $lowwer=""){
		...
		if ($tipo=="N") {
			//Substitui tudo que não é numero
	...
	/*
	 *  Função que converte o array para o formato JSON
	 */
	public static function encodeJSON($array){
		//return json_encode($array); Só converte dados com codificação UTF-8
		return self::my_json_encode($array);
	}


	/*
	 *  Função que converte o JSON para Array
	 */
	...
	/*
	 *  Função para converter um array ou um objeto em formato JSON substituindo a função do PHP "json_encode"
	 *  A função do PHP "json_encode" só consegue converter dados com codificação UTF-8.
	...
	/*
	 *  Função para converter um json em formato array substituindo a função do PHP "json_decode"
	 *  A função do PHP "json_decode" só consegue converter dados com codificação UTF-8.
    ...
    // Propósito: Gerar hash da senha conforme o tipo de criptografia.
    // Utilização: password_hash($password_clear, $enc_type)
    // - $password_clear: A senha em texto plano à ser codificada.
