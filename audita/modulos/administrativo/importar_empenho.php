	...
	function importFile(){
		if($F('upload') != ""){
			...
			if(permitida){
				...
				var form_upload = new Element("form", { id:"form_upload", name:"form_upload", method:"POST", enctype:"multipart/form-data", target:"iframe_upload", action:"./modulos/administrativo/inc_import_empenho.php", style:"display: none;"});
