...
function __autoload($classe){
	...
	if($_GET['order_by'] != ""){
		...
		$ORDER = " ORDER BY nm_unidade_medida";
	}

	if($_GET['ord'] != "") $ORDER .= " ".$_GET['ord'];


    $sql = "SELECT id_unidade_medida, nm_unidade_medida FROM tipo_unidade_medida $ORDER";
    //echo $sql; exit;
	...
	"nm_unidade_medida"	=>"Unidade de Medida"
	);
	...
	$largura = array(
	"id_unidade_medida"	=>"200px",
	"nm_unidade_medida"	=>"500px"
	);
