...
if($erros){ ?>
		...
		<br>
		<pre class="erro" align="center">Ocorreu algum erro no momento da Devolução da Nota Fiscal para o Beneficiário.<br>Verifique se essa nota ja não foi analisada.</pre>
		<p align="center">
...
$pdf->SetY(45);
$pdf->MultiCell(0, 0, "TERMO DE DEVOLUÇÃO DA NOTA FISCAL PARA O BENEFICIÁRIO", 0, 'C');
...
$pdf->MultiCell(0, 6, "MOTIVOS DA DEVOLUÇÃO:".ajustaTexto(@$_POST['id_questao'], $dados_questao, $_POST['ds_pendencias']), 1, 1, 'J');
...
//$mail->FromName = $nome;
//$mail->From = $email;
$mail->Subject = 'DEVOLUÇÃO DA NOTA FISCAL PARA O BENEFICIÁRIO';
