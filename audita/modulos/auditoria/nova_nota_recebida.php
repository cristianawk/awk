...
<p class="erro">Atenção! Já foi dado o recebimento da Nota Fiscal.<br>Se desejar enviar o email para o fornecedor novamente, clique no botão <b><i>reenviar o email</i></b>.</p>
<?php
