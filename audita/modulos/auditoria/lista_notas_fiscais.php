...
$conn->query("SELECT id_notafiscal, nr_notafiscal, to_char(dt_notafiscal, 'DD/MM/YYYY') AS dt_notafiscal
...
<tr>
	...
	<th width="3%"><a href="#" onclick="javascript:loadNotaFiscal('<?php echo $notafiscal['id_requisicao']?>', '<?php echo $notafiscal['id_empenho']?>')" title="Nota fiscal do fornecedor <?php echo $notafiscal['nm_fornecedor']?>"><img src="./imagens/combo.gif"></a></th>
</tr>
<?php }
} else {?>
