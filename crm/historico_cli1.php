...
$result1 = mysql_query("SELECT * FROM clientes where cliente_prospecto_id = '$idd'");
...
<form id="historico" name="historico" method="POST" action="<?php $_SERVER['PHP_SELF']; ?>?idd=<?php echo $row1["cliente_prospecto_id"]; ?>&id=<?php echo $row1["cliente_id"]; ?>">
