...
function validaUsuario($usuario, $senha) {
	...
	$sql = mysql_query("SELECT * FROM usuarios_arquivos WHERE usuarios_arquivos_login = '$nusuario' AND usuarios_arquivos_senha ='$nsenha' LIMIT 1");
	//$sql2 = ("SELECT * FROM usuarios_arquivos WHERE usuarios_arquivos_login = '$nusuario' AND usuarios_arquivos_senha ='$nsenha' LIMIT 1");
	//echo"<br>sql: <pre>";print_r($sql2);echo"</pre>";exit;
	...
	$_SESSION['usuarioIDa'] = $resultado['usuarios_arquivos_id']; 
	$_SESSION['usuarioNivela'] = $resultado['usuarios_arquivos_nivel'];// Pega o valor da coluna 'id do registro encontrado no MySQL
	$_SESSION['usuarioNomea'] = $resultado['usuarios_arquivos_nome']; // Pega o valor da coluna 'nome' do registro encontrado no MySQL
