...
$query2 = mysql_query("SELECT * FROM usuarios_arquivos where usuarios_arquivos_id ='$usuario_id'");
$row2 = mysql_fetch_array($query2);
$setor_id = $row2["usuarios_arquivos_visualiza"];

if($nivel == "0"){

$query = mysql_query("SELECT * FROM setores_arquivos where setor_arquivo_id ='$setor_id'");
}elseif($nivel == "1"){
	
	$query = mysql_query("SELECT * FROM setores_arquivos");
...
<?php if($nivel == '1'){ ?><div id="menu_arquivos"><a href="usuarios.php">Gerenciar Usuários</a></li></div><?php } ?>
