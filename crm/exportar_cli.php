...
$query = mysql_query("SELECT * FROM clientes where cliente_origem = 'Indicação' ORDER BY cliente_nome ASC");

$query1 = mysql_query("SELECT * FROM clientes where cliente_origem = 'site' ORDER BY cliente_nome ASC");

$query2 = mysql_query("SELECT * FROM clientes where cliente_origem = 'ligação direta' ORDER BY cliente_nome ASC");
