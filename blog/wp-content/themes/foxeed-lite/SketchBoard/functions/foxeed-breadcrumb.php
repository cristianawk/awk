...
class foxeed_lite_breadcrumb_class {
    ...
    function custom_breadcrumb() {
        ...
        $this->opts = array(
            ...
            'delimiter' => '<span class="foxeed-breadcrumbs-separator"> / </span>'
        ...
        echo '<div class="cont_nav"><div class="cont_nav_inner"><p><a href="' . esc_url(home_url('/')) . '/">' . __('Home', 'foxeed-lite') . '</a>';
    ...
    function simple_breadcrumb_case($der_post) {
        ...
        if (is_author()) {
            ...
            return __('Author', 'foxeed-lite') . ' : ' . $curauth->display_name;

        }

        if (is_tag()) {

            return __('Tag', 'foxeed-lite') . ' : ' . single_tag_title('', false);

        }

        if (is_search()) {

            return __('Search', 'foxeed-lite');

        }

		if (is_404()) {

            return __('Error 404', 'foxeed-lite');
        }
...
$foxeed_lite_breadcumb = new foxeed_lite_breadcrumb_class();
