					...
					<div class="post" id="post-<?php the_ID(); ?>">
					  <div class="single_post_wrap">
						<?php if ( has_post_thumbnail() ) { // check if the post has a Post Thumbnail assigned to it. ?>
							<div class="featured-image-shadow-box quote_featured_img">
								<?php the_post_thumbnail('foxeed_standard_img'); ?>
							</div>
						<?php } ?>

						<div class="post_inner_wrap clearfix">
							<?php get_template_part('includes/meta','section'); ?>
							<!-- skepost-meta -->
					        <div class="skepost">
								<?php the_content(); ?>
								<br />
				      ...
				      <!-- single-post-wrap -->
						...
						<div class="navigation"> 
							<?php previous_post_link( __('<span class="nav-previous"><i class="fa fa-angle-left"></i> %link</span>','foxeed-lite')); ?>
							<?php next_post_link( __('<span class="nav-next">%link <i class="fa fa-angle-right"></i></span>','foxeed-lite')); ?> 
						</div>
